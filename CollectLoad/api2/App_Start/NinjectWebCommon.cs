...
//using Common;
//using Adaptor;
using ReportApi.App_Start;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(NinjectWebCommon), "Stop")]

namespace ReportApi.App_Start
{
    using System;
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            kernel.Bind<IRequestHandler<GetCpuFeedQuery, List<LoadDetail>>>().To<GetCpuFeedQueryHandler>();
             kernel.Bind<IFeedQueryRepository>().To<FeedQueryRepository>();
